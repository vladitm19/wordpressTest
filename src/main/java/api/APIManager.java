...
public class APIManager {
    ...
    public Response post(String endpoint, Headers headers) {
        return RestAssured.given().headers(headers).post(endpoint);
    }
    ...
    public Response delete(String endpoint, Headers headers, Map<String, Object> queryParams) {
